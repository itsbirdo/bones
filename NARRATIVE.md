...
> **VITO.** Sit. You don't look like a man holding my money.
>
> *(you don't sit)*
>
...
>
> **VITO.** Miss one… and the river's cold this time of year.

*You take the marker. Outside, it hasn't stopped raining in a week.*

Button: **TAKE THE MARKER**

---

## 3. Each night

**Night card** (before play): *NIGHT {n}* · *The marker says ${demand}.*

Flavor by night (optional, escalating dread):
- N1: *Easy money. Almost.*
- N2: *He'll want more tomorrow. He always wants more.*
- N3: *The marks are getting wise to your bones.*
- N4: *Word's out you cheat. So they cheat back.*
- N5: *Every table feels rigged now. That's because it is.*
- N6: *One more night. Then Vito.*
...
- **Pay, comfortable:** *He counts it twice, pockets it. "Vito says hello." Gone before the door swings shut.*
- **Pay, barely:** *He counts slow, eyes on your face the whole time. Comes up exact. He almost looks let down.*
- **Can't pay:** *He stops counting. Looks up. "That's it?"*
...
## 7. UI & system copy  *(short strings)*
...
## 8. Rotating marks  *(optional one-line intros as opponents fade your bets)*

- **Nervous rookie:** *Keeps glancing at the alley mouth. New money, soft hands.*
...
*Next passes: name/voice for the Collector, a Vito send-off line per loss type, and tightening the
night-flavor lines once pacing is tuned.*
